...
class Todo extends Component {
    ...
    onSubmitHandle(event) {
        ...
        const addItemUrl = 'http://5d6190ac5f64870014060505.mockapi.io/api/v1/mockData';
    ...
    onDeleteHandle() {
        let id = arguments[0];
        const deleteItemUrl = 'http://5d6190ac5f64870014060505.mockapi.io/api/v1/mockData/' + id;
        axios
    ...
    onUpdateHandle(event) {
        ...
        let updatedItem = '';
        const updateItemUrl = 'http://5d6190ac5f64870014060505.mockapi.io/api/v1/mockData/' + id;
                    ...
                    <div className="todo-list-wrapper">
                        <ul className="item-wrapper">
                            ...
                            {this.state.mockData.map(item => (
                                <li key={item.id} className={item.done ? ' list-item done' : 'list-item hidden'}>
                                    <div className="d-flex item-row">
                                        ...
                                        <div className="col">
                                            ...
                                            <button
                                                onClick={this.onCompleteHandle.bind(this, (item.done = true), item.id)}
                                                className="btn btn-item"
                                                type="submit"
                                            >
